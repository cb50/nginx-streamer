...
sed -i "s|%%BLACKLIST_MESSAGE%%|${BLACKLIST_MESSAGE}|g" /usr/share/nginx/html/blacklist.html
sed -i "s|%%GANALYTICS%%|${GANALYTICS}|g" /usr/share/nginx/html/blacklist.html
...
sed -i "s|%%BLACKLIST_IPS%%|${BLACKLIST_IPS}|g" /opt/nginx/conf/nginx.conf
